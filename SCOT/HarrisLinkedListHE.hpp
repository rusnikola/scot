#ifndef _TIM_HARRIS_LINKED_LIST_HE_H_
#define _TIM_HARRIS_LINKED_LIST_HE_H_
...
private:
    ...
    const int kHe2 = 2; // the last safe node (prev)
    const int kHe3 = 3; // the first unsafe node
...
public:
    ...
    HarrisLinkedListHE(const int maxThreads) : maxThreads{maxThreads} {
...
#endif /* _TIM_HARRIS_LINKED_LIST_HE_H_ */
