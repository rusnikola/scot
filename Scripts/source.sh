...
commands=(
    './SCOT/bench list 10 16 5 50 25 25 NR'
    ...
    './SCOT/bench list 10 512 5 50 25 25 NR'
    ...
    './SCOT/bench list 10 20000 5 50 25 25 NR'
    './SCOT/bench list 10 20000 5 50 25 25 EBR'
    './SCOT/bench list 10 20000 5 50 25 25 HP'
    './SCOT/bench list 10 20000 5 50 25 25 IBR'
    './SCOT/bench list 10 20000 5 50 25 25 HE'
    './SCOT/bench list 10 20000 5 50 25 25 HYALINE'
    './SCOT/bench list 10 16 5 0 50 50 NR'
    ...
    './SCOT/bench list 10 512 5 0 50 50 NR'
    ...
    './SCOT/bench list 10 20000 5 0 50 50 NR'
    './SCOT/bench list 10 20000 5 0 50 50 EBR'
    './SCOT/bench list 10 20000 5 0 50 50 HP'
    './SCOT/bench list 10 20000 5 0 50 50 IBR'
    './SCOT/bench list 10 20000 5 0 50 50 HE'
    './SCOT/bench list 10 20000 5 0 50 50 HYALINE'
    './SCOT/bench list 10 16 5 90 5 5 NR'
    ...
    './SCOT/bench list 10 512 5 90 5 5 NR'
    ...
    './SCOT/bench list 10 20000 5 90 5 5 NR'
    './SCOT/bench list 10 20000 5 90 5 5 EBR'
    './SCOT/bench list 10 20000 5 90 5 5 HP'
    './SCOT/bench list 10 20000 5 90 5 5 IBR'
    './SCOT/bench list 10 20000 5 90 5 5 HE'
    './SCOT/bench list 10 20000 5 90 5 5 HYALINE'
    ...
    './SCOT/bench tree 10 128 5 0 50 50 NR'
    ...
    './SCOT/bench tree 10 100000 5 0 50 50 NR'
    ...
    './SCOT/bench tree 10 128 5 90 5 5 NR'
    ...
    './SCOT/bench tree 10 100000 5 90 5 5 NR'
